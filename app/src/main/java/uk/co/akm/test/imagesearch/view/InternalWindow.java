...
final class InternalWindow {
    ...
    static boolean canInitializeWindow(View parent, MotionEvent event, float windowInitialSideFraction) {
    ...
    void onChangePositionOrSizeTouchEvent(MotionEvent event) {
